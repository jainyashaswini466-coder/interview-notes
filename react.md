...
6. [What is the difference between class components and functional components?](#q6-what-is-the-difference-between-class-components-and-functional-components)
7. [What are React Hooks?](#q7-what-are-react-hooks)
8. [Explain useState, useEffect, useLayoutEffect, useMemo, useCallback, useRef](#q8-explain-usestate-useeffect-uselayouteffect-usememo-usecallback-useref)
9. [What are custom hooks and when to use them?](#q9-what-are-custom-hooks-and-when-to-use-them)
10. [Explain React.memo and how it helps in optimization](#q10-explain-reactmemo-and-how-it-helps-in-optimization)
11. [Explain Context API and how to integrate it](#q11-explain-context-api-and-how-to-integrate-it)
12. [What is prop drilling and how to avoid it?](#q12-what-is-prop-drilling-and-how-to-avoid-it)
13. [When and how to use lazy loading?](#q13-when-and-how-to-use-lazy-loading)
14. [What is Virtual DOM?](#q14-what-is-virtual-dom)
15. [What is reconciliation in React (how React updates DOM)?](#q15-what-is-reconciliation-in-react-how-react-updates-dom)
16. [How to route between pages in React?](#q16-how-to-route-between-pages-in-react)
17. [What are error boundaries in React?](#q17-what-are-error-boundaries-in-react)
18. [What are controlled and uncontrolled components?](#q18-what-are-controlled-and-uncontrolled-components)
19. [What are keys in lists and why are they important?](#q19-what-are-keys-in-lists-and-why-are-they-important)
20. [What is React Fragment and why is it used?](#q20-what-is-react-fragment-and-why-is-it-used)
21. [What are higher-order components (HOCs)?](#q21-what-are-higher-order-components-hocs)
22. [What are lifecycle methods in class components?](#q22-what-are-lifecycle-methods-in-class-components)
23. [What is Redux and Redux Toolkit? How do you create a store?](#q23-what-is-redux-and-redux-toolkit-how-do-you-create-a-store)
24. [How to structure a React application folder?](#q24-how-to-structure-a-react-application-folder)
25. [How will you handle authentication and where to store the token?](#q25-how-will-you-handle-authentication-and-where-to-store-the-token)
26. [What are interceptors in Axios?](#q26-what-are-interceptors-in-axios)
27. [How to handle state in large applications?](#q27-how-to-handle-state-in-large-applications)
28. [How to debug a React application?](#q28-how-to-debug-a-react-application)
29. [Is React a framework?](#q29-is-react-a-framework)
30. [How to handle large number of records in a table (virtualization)?](#q30-how-to-handle-large-number-of-records-in-a-table-virtualization)
31. [What is React Portal and when to use it?](#q31-what-is-react-portal-and-when-to-use-it)
32. [Difference between useEffect and useLayoutEffect?](#q32-difference-between-useeffect-and-uselayouteffect)
33. [What is useReducer and when to use it?](#q33-what-is-usereducer-and-when-to-use-it)
34. [What is React.StrictMode and why is it used?](#q34-what-is-reactstrictmode-and-why-is-it-used)
35. [What are synthetic events in React?](#q35-what-are-synthetic-events-in-react)
36. [What is code splitting and chunking in React?](#q36-what-is-code-splitting-and-chunking-in-react)
37. [What is server-side rendering (SSR) vs client-side rendering (CSR)?](#q37-what-is-server-side-rendering-ssr-vs-client-side-rendering-csr)
38. [What are performance optimization techniques in React?](#q38-what-are-performance-optimization-techniques-in-react)
39. [What are controlled vs uncontrolled inputs (forms)?](#q39-what-are-controlled-vs-uncontrolled-inputs-forms)
40. [How does React handle events differently from browser DOM?](#q40-how-does-react-handle-events-differently-from-browser-dom)
41. [What is state lifting?](#q41-what-is-state-lifting)
42. [What is the difference between default export and named export in React?](#q42-what-is-the-difference-between-default-export-and-named-export-in-react)
43. [Create a component rendering data with pagination](#q43-create-a-component-rendering-data-with-pagination)
---
